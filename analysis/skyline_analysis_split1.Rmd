---
title: "Skyine Analysis - Split Application Experiment"
author: "Peter Levy"
output:
  html_document:
    number_sections: yes
...
here::i_am("analysis/skyline_analysis_split1.Rmd")
#renv::install("ggeffects")
library(here)
library(quarto)
library(rmarkdown)
quarto_render(here("analysis/skyline_analysis_split1.Rmd"))
render(input = here("analysis", "skyline_analysis_split1.Rmd"), output_file = here("analysis", "skyline_analysis_split1.pdf"))
render(input = here("analysis", "skyline_analysis_split1.Rmd"), output_file = here("analysis", "skyline_analysis_split1.html"))
```
