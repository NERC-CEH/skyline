...
here::i_am("analysis/skyline_analysis_biochar1.Rmd")
#renv::install("ggeffects")
library(here)
library(quarto)
library(rmarkdown)
quarto_render(here("analysis/skyline_analysis_biochar1.Rmd"))
render(input = here("analysis", "skyline_analysis_biochar1.Rmd"), output_file = here("analysis", "skyline_analysis_biochar1.pdf"))
render(input = here("analysis", "skyline_analysis_biochar1.Rmd"), output_file = here("analysis", "skyline_analysis_biochar1.html"))
```
