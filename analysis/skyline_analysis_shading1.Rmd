---
title: "Skyine Analysis - Hazelrigg Shading Experiment"
author: "Peter Levy"
output:
  html_document:
    number_sections: yes
...
here::i_am("analysis/skyline_analysis_shading1.Rmd")
#renv::install("ggeffects")
library(here)
library(quarto)
library(rmarkdown)
quarto_render(here("analysis/skyline_analysis_shading1.Rmd"))
render(input = here("analysis", "skyline_analysis_shading1.Rmd"), output_file = here("analysis", "skyline_analysis_shading1.pdf"))
render(input = here("analysis", "skyline_analysis_shading1.Rmd"), output_file = here("analysis", "skyline_analysis_shading1.html"))
```
